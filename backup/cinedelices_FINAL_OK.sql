...
CREATE TABLE public.recipes (
    ...
    img_url character varying(255),
    category public.enum_recipes_category NOT NULL,
    is_validated boolean DEFAULT false NOT NULL,
...
SELECT pg_catalog.setval('public.ingredients_id_seq', 267, true);
...
SELECT pg_catalog.setval('public.media_id_seq', 49, true);
